...
public class DateUtil {
	...
	public static DateFormat angularDateFormat = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
	...
	public static Date angularStringToDate(String date){
		try {
			return angularDateFormat.parse(date);
