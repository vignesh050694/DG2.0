...
public class ProcurementStockSpecification extends BaseSpecification implements Specification<ProcurementStock> {
    private SearchCriteria criteria;

    public ProcurementStockSpecification(SearchCriteria criteria) {
