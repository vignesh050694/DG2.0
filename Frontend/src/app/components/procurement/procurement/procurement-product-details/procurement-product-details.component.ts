...
@Component({
  selector: 'app-procurement-product-details',
  templateUrl: './procurement-product-details.component.html',
  styleUrls: ['./procurement-product-details.component.scss']
})
export class ProcurementProductDetailsComponent implements OnInit {
  ...
  displayedColumns: string[] = ['productName', 'variety', 'grade', 'price', 'noOfBags', 'netWeight', 'actions'];
  definedColumns = ['productName', 'variety', 'grade', 'price', 'noOfBags', 'netWeight'];
  searchColumns: any[] = [];
